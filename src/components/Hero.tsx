  ...
  <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div className="text-white md:pr-10">
      ...
      <p className="text-lg md:text-xl leading-relaxed mb-6">
        We specialize in the export of premium-grade green coffee beans sourced
        from the finest plantations in the southern states of India—regions
        renowned for their fertile soil, ideal climate, and unique flavor
        profiles.
      </p>
      <p className="text-lg leading-relaxed opacity-90">
        Our expertise combines sustainable sourcing, strict quality checks, and
        global logistics to ensure our partners receive authentic coffee from
        India, crafted for world markets.
      </p>
    </div>
    ...
    <div className="bg-white p-8 rounded-2xl shadow-lg">
      <div className="grid gap-8 md:grid-cols-2 text-left">
        <div className="p-4 border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition">
          ...
          <p className="text-gray-600">
            Supplying Arabica and Robusta varieties to meet the growing global
            demand for high-quality beans.
          </p>
        </div>
        ...
        <div className="p-4 border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition">
          ...
          <p className="text-gray-600">
            Serving roasters, distributors, and importers across Europe, North
      ...
      <p className="mt-10 text-lg italic text-gray-700">
        For us, coffee export is not just a business—it’s a passion. We take
        pride in being part of every cup brewed with our beans, ensuring that
        our partners receive nothing less than the authentic taste of India’s
        coffee heritage.
      </p>
    </div>
  </div>
