      ...
      <div className="max-w-[80rem] mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md mt-16 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="p-8 md:w-1/2">
            ...
            <div className="space-y-4 text-[#5A4A42]">
              <p className="text-base leading-relaxed">The journey began with our coffee plantations in Southern India. For decades, we have supplied the local market with premium beans, ensuring excellence and consistency.</p>
              <p className="text-base leading-relaxed">Now, our prime focus is to expand globally, reaching coffee enthusiasts in Australia, New Zealand, and the GCC region.</p>
              <p className="text-base leading-relaxed">Our dedication to quality ensures that every coffee bean we export is of exceptional standard, ready to satisfy global markets.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
          <div className="p-8 bg-white rounded-lg shadow-md">
            ...
            <p className="text-[#5A4A42] text-base leading-relaxed">Rooted in the rich traditions of Southern India, our plantations have cultivated the finest coffee beans for generations. Our passion for sustainable farming ensures the highest quality harvests.</p>
          </div>
          <div className="p-8 bg-white rounded-lg shadow-md">
            <h3 className="text-2xl font-bold mb-4">Global Vision</h3>
            <p className="text-[#5A4A42] text-base leading-relaxed">As we expand to international markets, we uphold the same values of quality and dedication that define our brand. Our focus on sustainable and traceable sourcing guarantees excellence from farm to cup.</p>
          </div>
        </div>
      </div>
    </section>
